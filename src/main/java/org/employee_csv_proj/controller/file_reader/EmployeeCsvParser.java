...
public class EmployeeCsvParser {
    ...
    public static void addEmployeeDataToDatabase(DataCleanser cleansedData) {
        MyLogger.log(Level.INFO, "Checking for employee data.");
        ArrayList<String[]> employeeData = cleansedData.getProvidedList();
        Connection connection = DBConnectionManager.dbCompanyConnection();
        for (String[] employee : employeeData) {
            DatabaseOperations.addToDatabase(connection, new EmployeeDTO(employee));
